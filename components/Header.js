    ...
    return(
        <div className="flex h-screen relative" style={headerStyle}>
            ...
            <div className="flex-shrink h-full mx-auto flex flex-col items-center justify-center">
                {/* Header text */}
                <h1 className="text-2xl md:text-3xl text-white font-extrabold font-display text-center">Enjoy the best services at the <br className="hidden md:block" />comforts of your own home.</h1>
                {/* Search bar */}
